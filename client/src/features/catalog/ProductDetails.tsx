    ...
    <Grid2 container spacing={6} maxWidth='lg' sx={{mx: 'auto'}}>
      ...
      <Grid2 size={6}>
        ...
        <Grid2 container spacing={2} marginTop={3}>
          ...
          <Grid2 size={6}>
            <Button onClick={handleUpdateBasket} disabled={quantity === item?.quantity || (!item && quantity === 0)} sx={{height: '55px'}}color='primary' size='large' variant='contained' fullWidth>{item ? 'update quantity': 'Add to Basket'}</Button>
          </Grid2>
        </Grid2>
      </Grid2>      
    </Grid2>
